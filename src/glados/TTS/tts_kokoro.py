...
class Synthesizer:
    ...
    def synthesize_audio(self, text: str) -> NDArray[np.float32]:
        """
        Synthesize audio from text (compatibility method for GlaDOS engine).
        """
        return self.generate_speech_audio(text)
