...
MODEL_CHECKSUMS = {
    ...
    "models/ASR/nemo-parakeet_tdt_ctc_110m_tokens.txt": "",
...
MODEL_URLS = {
    "models/ASR/silero_vad_v5.onnx": "https://github.com/dnhkng/GlaDOS/releases/download/0.1/silero_vad_16k_op15.onnx",
    ...
    "models/ASR/nemo-parakeet_tdt_ctc_110m_tokens.txt": "https://huggingface.co/csukuangfj/sherpa-onnx-nemo-parakeet_tdt_ctc_110m-en-36000/resolve/main/tokens.txt",
...
def say(text: str, config_path: str | Path = "glados_config.yaml") -> None:
    ...
    try:
        ...
        voice = glados_config.voice if glados_config.voice != "glados" else "af_alloy"
    except Exception:
        voice = "af_alloy"

    glados_tts = tts_kokoro.Synthesizer(voice=voice)
